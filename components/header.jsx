    ...
    <header className={nav_class}>
        ...
        <nav>
          <div className="md:hidden">
            {/* Mobile Navigation */}
            <div id="svg" className="z-20 ">              
               <svg data-name="Layer 1" id="Layer_1" onClick={prop} viewBox="0 0 64 64" width="30px" height="30px" className="cursor-pointer fill-skyblue pt-1" xmlns="http://www.w3.org/2000/svg"><path d="M21.86,18.73H9.18a2,2,0,0,1,0-4H21.86a2,2,0,0,1,0,4Z"/><path d="M54.82,18.73H34.88a2,2,0,0,1,0-4H54.82a2,2,0,0,1,0,4Z"/><path d="M54.82,34H9.18a2,2,0,0,1,0-4H54.82a2,2,0,0,1,0,4Z"/><path d="M54.82,49.27H30.07a2,2,0,0,1,0-4H54.82a2,2,0,0,1,0,4Z"/></svg>
               {/* <div id="bglight" onClick={()=>{setMode(moon)}} className="dark inline-block mt-2 px-2 ml-3 h-7 w-7 relative -top-1">
                  {mode}
               </div> */}
            </div>
          </div>
