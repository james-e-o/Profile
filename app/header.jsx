            ...
            <header  className=" h-16 pt-2 w-screen lg:h-[14vh] z-[0] bg-white ">     
                    <div className='max-w-[83rem] h-full mx-auto flex items-center justify-between px-3 sm:px-6 md:px-10 py-4 bg-white relative'>
                        ...
                        <div onClick={()=>setDropState(!dropState)} className='inline-block sm:hidden border-none mr-2 relative -top-1 py-1 px-3 '>
                            ...
                            <ul className={!dropState? "flex-col justify-center  flex gap-4 items-center font-semibold text-[#7a7a7a] font-Inter p-2 w-28 h-fit text-sm top-[100%] border border-[#b1b1b1] pointer-events-none opacity-0 bg-white absolute right-0 rounded-lg transition-[_top_100ms_ease-out]":"flex-col justify-center flex gap-4 items-center font-semibold text-[#7a7a7a] font-Inter p-2 w-[40vw] text-sm h-fit top-14 border border-gray-400 backdrop-blur-md shadow-lg transition-[_top_100ms_ease-out] bg-white absolute right-0 rounded-lg"}>   
