...
export default function Home() {
    ...
    const data = <div onPointerMove={(e)=>{e.preventDefault()}} className="flex flex-col justify-between h-screen overflow-hidden bg-gradient-to-b from-blue-200 to- bg-darkNavy"> 
