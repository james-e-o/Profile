  ...
  return (
    <div>
        ...
        <main>
            <div class="icons">
=======
    const className = "text-yellow-500 font-sans text-5xl m-0 pl-4"
  return (
    <div > 
        <Nav logo={logo} color={className}/>
        <main className="m-0 pl-4"> 
            <div >
                <h3>
                    <span className="w-3 h-3">&#x1F590;</span><span className="text-yellow-400">Hey There, I'm James</span>
                </h3>
                <h1>I am a frontend web developer</h1>
                <p id="info" className="text-gray-400">I bring web designs to life by creating impressive user experiences and reactive websites, using HTML, JavaScript, React js, CSS, Tailwind, Node js, and other Javascript based tools, packages and libraries. </p>
                <p id="CTA">View my Resume</p>
            </div>
            <div >
>>>>>>> 20db70a25976c22d4640b6f04e2eef8e0d7a87af
