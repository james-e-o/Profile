...
export default function Home() {
    ...
    const data = <div className="flex flex-col justify-between min-h-screen"> 
        <Nav logo={logo} color={className}/>
        <main className="m-0 py-2 px-7"> 
            <div >
                <h4 className="m-0 pb-1">
                    <span className="w-3 h-3">&#128075;</span>
                    <span className="text-orange-300">Hey There, I'm James</span>
                </h4>
        ...
        <footer className="m-0 px-6 pb-10 flex justify-center">
            <div id='page-footer' className="pb-5">
