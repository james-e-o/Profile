...
export default function Home() {
    ...
    const data = <div id="container" className="relative  justify-between bg-[#201c2e] h-vh92 lg:h-screen "> 
        ...
        <Mobile_menu/>
        <main className="m-0 py-2 px-7 flex flex-col"> 
            <div id="main_wrapper" className="opacity-100 relative translate-y-0 animate-land_anime2">
                ...
                <h2 className=" ml-[50px] mt-14 text-3xl font-Orbitron font-semibold">frontend web developer <svg xmlns="http://www.w3.org/2000/svg" className="animate-anime relative top-1  w-9 h-9 fill-yellow-400" viewBox="0 0 384 512"><path d="M192 32c17.7 0 32 14.3 32 32V199.5l111.5-66.9c15.2-9.1 34.8-4.2 43.9 11s4.2 34.8-11 43.9L254.2 256l114.3 68.6c15.2 9.1 20.1 28.7 11 43.9s-28.7 20.1-43.9 11L224 312.5V448c0 17.7-14.3 32-32 32s-32-14.3-32-32V312.5L48.5 379.4c-15.2 9.1-34.8 4.2-43.9-11s-4.2-34.8 11-43.9L129.8 256 15.5 187.4c-15.2-9.1-20.1-28.7-11-43.9s28.7-20.1 43.9-11L160 199.5V64c0-17.7 14.3-32 32-32z"/></svg>
                </h2>
            </div> 
            <div id='lower-main' className="flex ">
                <div id='svg-container' className="py-2 pr-3 animate-blink_anime">            
        ...
        <footer className="m-0 px-4 pb-6 flex justify-center">
