...
export default function Home() {
    ...
    const data = <div id="container" className="flex flex-col justify-between h-screen lg:h-screen bg-gradient-to-b from-blue-900 to- bg-darkNavy"> 
        ...
        <footer className="m-0 px-4 pb-7 flex justify-center">
