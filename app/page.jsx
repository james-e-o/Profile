        ...
        <main className="py-2 px-7"> 
            ...
            <div id='lower-main' className="flex mt-2">
                ...
                <div id='right-low'>
                    ...
                    <p id="CTA" 
                    className="px-2 py-1 mt-10 bg-skyblue inline-block text-black text-sm font-thin">
                    <span className=" transform scale-150 m-0 pr-1 border-spacing-0 border-0 text-pink-500"> →</span> 
                    View my Resume</p>
                </div>
            </div>
        </main>
