...
export default function Home() {
    ...
    const data = <div id="container" className="flex flex-col justify-between overflow-hidden fixed h-over lg:h-screen bg-gradient-to-b from-blue-900 to- bg-darkNavy"> 
        ...
        <footer className="m-0 px-4 pb-10 flex justify-center">
