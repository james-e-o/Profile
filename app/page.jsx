...
export default function Home() {
    ...
    const data = <div id="container" className="flex flex-col justify-between overflow-hidden h-variable lg:h-screen bg-gradient-to-b from-blue-900 to- bg-darkNavy"> 
