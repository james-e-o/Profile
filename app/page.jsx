...
export default function Home() {
    ...
    const data = <div id="container" className="flex flex-col justify-between h-vh95 lg:h-screen bg-gradient-to-b from-blue-800 to- bg-slate-950"> 
    
        <Nav logo={logo} color={className}/>
        <main className="m-0 py-2 px-7"> 
            <div >
                <h4 className="m-0 pb-1">
                    <span className="w-3 h-3 fill-amber-700">&#128075;&#127998;</span>
                    <span className="text-gray-300 bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-yellow-300 ">Hey There, I'm James</span>
                </h4>
        ...
        <footer className="m-0 px-4 pb-4 flex justify-center">
